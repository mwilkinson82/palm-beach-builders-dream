                  ...
                  <div className="lg:col-span-7">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-accent/15 border border-accent/20">
                      {[
                        {
                          k: "Live CPM Schedule",
                          v: "The master timeline that drives every trade.",
                        },
                        {
                          k: "Daily Logs",
                          v: "Field reports, photos, and decisions — recorded each day.",
                        },
                        {
                          k: "Owner Portal",
                          v: "24/7 access for owner, architect, and designer.",
                        },
                        {
                          k: "Selection Curation",
                          v: "Dream board → approval → procurement → install.",
                        },
                      ].map((card, i) => (
                        <RevealAnimation key={card.k} animation="fade-up" delay={i * 90}>
                          <div className="h-full bg-card p-8 md:p-10 transition-colors duration-500 hover:bg-[hsl(var(--seafoam))]/40">
                            <div className="flex items-baseline gap-4 mb-4">
                              <span className="font-display text-3xl md:text-4xl text-accent/70 leading-none">
